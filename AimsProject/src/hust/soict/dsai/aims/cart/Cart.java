...
public class Cart {
	...
	public Cart() {
		itemsOrdered.add(new Book("Chemistry","Dang Huy",12.3f,20));
		itemsOrdered.add(new Book("Chemistry","Dang Huy",12.3f,20));
		itemsOrdered.add(new Book("Chemistry","Dang Huy",12.3f,20));
	}
	public void addMedia(Media newItem) throws LimitExceededException{
		if (!itemsOrdered.contains(newItem) && itemsOrdered.size() < 20) {
